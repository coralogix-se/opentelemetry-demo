...
const {
  ...
  OTEL_COLLECTOR_HOST,
  CORALOGIX_RUM_PUBLIC_KEY,
  CORALOGIX_RUM_APPLICATION_NAME,
  CORALOGIX_RUM_APPLICATION_VERSION,
    ...
    try {
      ...
      const envString = `
        window.ENV = {
          ...
          NEXT_PUBLIC_CORALOGIX_RUM_PUBLIC_KEY: '${CORALOGIX_RUM_PUBLIC_KEY || ''}',
          NEXT_PUBLIC_CORALOGIX_RUM_APPLICATION_NAME: '${CORALOGIX_RUM_APPLICATION_NAME || ''}',
          NEXT_PUBLIC_CORALOGIX_RUM_APPLICATION_VERSION: '${CORALOGIX_RUM_APPLICATION_VERSION || ''}',
